...
def run(args):
    ...
    for i in range(num_records):
        ...
        try:
            #NHATnote: Vi sao khi train thi chi dung image extract ra (tat nhien day chi la code example), con khi train thi can signal gi day?
